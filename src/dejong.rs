...
pub struct DeJong {
    x: f32,
    y: f32,
    trail: [(i8, i8, u8); TRAIL_LEN], // (px, py, quadrant 0-3)
    trail_idx: usize,
}
...
impl DeJong {
    ...
    pub fn step(&mut self) {
        ...
        // Quadrant encodes hue: top-right=0, top-left=1, bottom-left=2, bottom-right=3
        ...
        self.trail[self.trail_idx] = (px, py, quadrant);
        ...
        D: DrawTarget<Color = Rgb555>,
    {
        ...
        for i in 0..TRAIL_LEN {
            ...
            let (px, py, quadrant) = self.trail[idx];
